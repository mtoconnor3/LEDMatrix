# 8x8 bitmap font — each entry is 8 row bytes, MSB (bit 7) = leftmost pixel.
# Covers printable ASCII: uppercase, lowercase, digits, and common punctuation.
FONT_8X8: dict[str, list[int]] = {
    ...
    '4': [0x06, 0x1E, 0x36, 0x66, 0x7F, 0x06, 0x06, 0x00],
